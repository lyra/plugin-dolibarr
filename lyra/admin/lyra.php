...
$validation_mode = array(
    '' => $langs->trans('LYRA_VALIDATION_MODE_BACK_OFFICE_CONF'),
...
$form_type = array(
    '1' => $langs->trans('LYRA_CARD_INFO_MODE_FORM'),
    '4' => $langs->trans('LYRA_CARD_INFO_MODE_EMBEDDED'),
    '5' => $langs->trans('LYRA_CARD_INFO_MODE_POPIN')
);
...
$arrayofparameters = array(
    ...
    'LYRA_PAYMENT_GATEWAY_ACCESS' => array(
        ...
        'LYRA_SIGN_ALGO'   => array('type' => 'input', 'css' => 'minwidth500', 'enabled' => 0, 'info' => $langs->trans('LYRA_SIGN_ALGO_DESC')),
